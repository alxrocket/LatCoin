...
RESOURCES += src/qt/latcoin.qrc src/qt/latcoin_locale.qrc
TRANSLATIONS += src/qt/locale/latcoin_bg.ts \
                src/qt/locale/latcoin_de.ts \
                src/qt/locale/latcoin_en.ts \
                src/qt/locale/latcoin_es.ts \
                src/qt/locale/latcoin_fi.ts \
                src/qt/locale/latcoin_fr.ts \
                src/qt/locale/latcoin_it.ts \
                src/qt/locale/latcoin_ja.ts \
                src/qt/locale/latcoin_pl.ts \
                src/qt/locale/latcoin_pt.ts \
                src/qt/locale/latcoin_ru.ts \
                src/qt/locale/latcoin_sk.ts \
                src/qt/locale/latcoin_sv.ts \
                src/qt/locale/latcoin_vi.ts \
                src/qt/locale/latcoin_zh_CN.ts \
                src/qt/locale/latcoin_zh_TW.ts
