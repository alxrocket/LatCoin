...
Only requiring some minor changes is latcoin.cpp.
...
Changes to latcoin.cpp
----------------------
latcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
