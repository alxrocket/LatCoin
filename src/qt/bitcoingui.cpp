    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Latcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and latcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Latcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Latcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a latcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Latcoin Core help message to get a list with possible Latcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Latcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Latcoin Core"); // default title
