...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Latcoin Core latcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  latcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded latcoin transaction") + "\n" +
              "  latcoin-tx [options] -create [commands]   " + _("Create hex-encoded latcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded latcoin transaction
