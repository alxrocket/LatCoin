...
/* *** BEGIN DARKSEND MAGIC - LATCOIN **********
    Copyright (c) 2014-2015, Latcoin Developers
        eduffield - evan@latcoin.io
        udjinm6   - udjinm6@latcoin.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Latcoin and make it unusable. To
