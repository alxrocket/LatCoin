...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Latcoin features */
    { "latcoin",               "masternode",             &masternode,             true,      true,       false },
    { "latcoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "latcoin",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "latcoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "latcoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "latcoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "latcoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "latcoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "latcoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use latcoind, or the -server option to latcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> latcoin-cli " + methodname + " " + args + "\n";
}
